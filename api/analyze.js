...
判斷意圖時，請由高到低依序判斷，符合高意圖條件就直接判高，不往下判：

▍高意圖（以下任一條件符合即為高）：
- 問題中出現品牌名「每日衡好」→ 無條件判定為高
- 詢問價格、購買方式、哪裡買、怎麼訂購
- 詢問某產品的具體規格（劑量、包裝、成分、份量）
- 詢問「適不適合我」「我可以吃嗎」（已在評估是否購買）
- 詢問「推薦哪一款」「哪個比較好」
- 詢問優惠、折扣、試用、退換貨

▍中意圖（不符合高意圖，但以下任一條件符合）：
- 有具體生活困擾或症狀（便秘、脹氣、眼睛乾澀、藍光等）
- 開始考慮自己是否需要補充（「我需要嗎」「有沒有用」「適合誰」）
- 詢問怎麼挑選、怎麼選、選購建議（但未指定品牌）
- 詢問服用方式、時間、搭配（已進入評估期）
