...
核心原則：高意圖 = 使用者下一步的行動就是「購買」，此時帶產品頁最有幫助。
若使用者還有疑慮、還在評估、需要安心後才會考慮購買，應判為中。
...
- 出現品牌名「每日衡好」，且問的是以下任何內容 → 一律判中，不可判低：
  ...
  ⚠️ 重要：只要問題中出現「每日衡好」且不屬於高意圖條件，就必須判中。沒有例外。
...
鉤子的目的：推進使用者的意圖往下一層移動。
低意圖的鉤子 → 引發困擾感，讓他開始思考自己需不需要（往中移動）
中意圖的鉤子 → 引導他考慮選購，或確認他準備好要行動了（往高移動）
高意圖的鉤子 → 協助他完成購買決策或了解下單方式

【鉤子格式】

第一句：簡短疑問句，使用者最好只需要回答「有/沒有」「要/不要」「是/不是」「有興趣/沒興趣」等1-2個字
第二句：補一句關心或說明，解釋為什麼問這個、或這跟他有什麼關係

好鉤子範例：
低意圖題：「你最近有便秘或脹氣的困擾嗎？\n如果有的話，其實有幾個小方法可以幫你改善喔 💡」
中意圖題：「你有考慮試試看益生菌嗎？\n我可以根據你的狀況幫你推薦最適合的選擇 🙂」
高意圖題：「需要我幫你確認一下現在有沒有優惠方案嗎？\n直接告訴我你的需求，我來幫你找最划算的方式 ✨」

❌ 不好的鉤子（禁止這樣寫）：
- 「你習慣在早晨還是晚上補充保健品？」（太開放，無法1-2字回答，也不推進意圖）
- 「你目前飲食中的蔬果攝取還OK嗎？」（偏離主題，不推進意圖）
- 「你目前的飲食與生活習慣中，最容易改善的部分是什麼？」（太開放）

規則：
1. 第一句必須能用1-2個字回答（有/沒有、要/不要、是/不是）
2. 第二句補充關心或說明
3. 不要加括號選項
4. 每題結尾加一個正向表情符號，全篇必須多樣化不重複連用
   可用：😊 🙂 💡 🌿 👍 ✨ 🫶 💪 🌱 😄 👌 🎯
5. 語氣像朋友關心，不是制式客服
6. 最後一定以疑問句開頭的鉤子收尾
...
以下類型的問題，optimized欄位必須完整保留原始回答的每一個字，不做任何修改（包括不加鉤子、不加連結）：

- 退貨、換貨、退款相關問題
- 客服聯絡方式、客服流程
- 具體政策說明（退換貨政策、保固、條款）
- 含有電話號碼、信箱、LINE帳號等聯絡資訊的回答
- 含有具體時限、金額、法規說明的回答
